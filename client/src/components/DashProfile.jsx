import { Alert, Modal, ModalHeader, TextInput } from 'flowbite-react'
...
export default function DashProfile() {
      ...
      uploadTask.on(
        ...
        () => {
          getDownloadURL(uploadTask.snapshot.ref).then((downloadURL) =>{
            ...
            setImageFileUploadProgress(null); // Reset progress after upload completes
        setImageFile(null);
    ...
    const handleSubmit = async (e) => {
      ...
      try {
        ...
        console.log("in dash",currentUser._id);
